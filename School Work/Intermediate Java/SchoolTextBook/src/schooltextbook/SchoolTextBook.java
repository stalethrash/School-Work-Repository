...
public class SchoolTextBook {
    ...
    public SchoolTextBook(String authorPub, String titlePub, int pageCountPub, 
            int isbnPub, double pricePub){
        authorPub = author;
        titlePub = title;
        pageCountPub = pageCount;
        isbnPub = isbn;
        pricePub = price;
    }
    ...
    public void setPageCount(int countSet){
        pageCount = countSet;
    }
    ...
    public void setIsbn(int isbnSet){
        isbn = isbnSet;
    }
